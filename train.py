...
filename = '20_news_group_to_train.csv.zip'
x_text, y,labels = data_helpers.load_data_labels(filename,1)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        if embedding_name == 'glove':
            initW = data_helpers.load_embedding_vectors_glove(vocabulary,'lsa_output', embedding_dimension)
